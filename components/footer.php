            ...
            <div class="col-lg-4 col-md-6 col-sm-7">
                <div class="footer__about">
                    <div class="footer__logo">
                        <a href="./index.html"><img src="upload/logo/logo-tusach.png" alt=""></a>
                    </div>
                    <p>Chào mừng bạn đến với Tủ Sách Online nơi cung cấp sách chất lượng giá rẻ</p>
                ...
                <div class="footer__copyright__text">
                    <p>Copyright &copy; <script>
                        document.write(new Date().getFullYear());
                            ...
                            href="https://www.facebook.com/hung.nguyen.980726" target="_blank">CN59 ALEX</a></p>
                </div>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </div>
        </div>
...
<script src="public/js/domain.js"></script>
