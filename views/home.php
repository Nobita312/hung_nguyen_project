            ...
            <div id="header-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" style="border-radius: 10px;">
                    <div class="carousel-item active">
                        <img class="img-fluid" src="upload/banner/banner-sach-1.png" alt="Image">

                    </div>
                    <div class="carousel-item">
                        <img class="img-fluid" src="upload/banner/banner-sach-2.png" alt="Image">
...
<section class="product spad" style="background-color: #F4F4F9;">
    ...
    <div class="container mt-5" style="background-color: #ffffff; border-radius: 10px;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                <img src="upload/banner/banner-sach-1.png" alt="Banner 1" class="img-fluid">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                <img src="upload/banner/banner-sach-2.png" alt="Banner 2" class="img-fluid">
            </div>
        </div>
    </div>
</section>
